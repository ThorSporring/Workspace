...
builder.Logging
    ...
    .AddConsole(options =>
    {
        var opt = new ConsoleFormatterOptions
        {
...
app.MapGet("/error",
    ...
    [ResponseCache(NoStore = true)] (HttpContext context) =>
    {
        ...
        var errorMessage = details.Detail;
        ...
        app.Logger.LogError(
            ...
            $"An unhandled exception occurred. Error message: {errorMessage}", errorMessage);
