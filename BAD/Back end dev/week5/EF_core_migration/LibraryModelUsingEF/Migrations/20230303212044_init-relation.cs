    ...
    public partial class initrelation : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookLoaner", x => new { x.BooksBookId, x.LoanersLoanerId });
                    table.ForeignKey(
                        name: "FK_BookLoaner_Books_BooksBookId",
                        column: x => x.BooksBookId,
                        principalTable: "Books",
                        principalColumn: "BookId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookLoaner_Loaners_LoanersLoanerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookLoaner_LoanersLoanerId",
                table: "BookLoaner",
                column: "LoanersLoanerId");
        }
